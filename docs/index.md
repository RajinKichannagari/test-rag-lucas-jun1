...
!!! info
    ...
    **Source Code Repository:** [https://github.com/RajinKichannagari/test-rag-lucas-jun1](https://github.com/RajinKichannagari/test-rag-lucas-jun1)

    **GitOps Repository:** [https://github.com/RajinKichannagari/test-rag-lucas-jun1-gitops](https://github.com/RajinKichannagari/test-rag-lucas-jun1-gitops)

# **Usage**

To access the test-rag-lucas-jun1 application that was deployed using the Software Template, complete the following instructions:
